...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 32223 or testnet: 132223)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 32222 or testnet: 132222)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Hicoin Wiki for SSL setup instructions)") + "\n" +
